...
Promise.resolve(1)
  ...
  .then(function(){
    ...
    return Promise.resolve(1)
      .then( () =>{ log('then 3.0') } )
      .then( () =>{ throw 'A' } )
      .catch( (e) =>{ log('catch 3.0 - ' + e) } )
      .then( () =>{ log('then 3.1') } )
      .catch( (e) =>{ log('catch 3.1 - ' + e) } )
  })
  .then(function(){
    log('###### case 4 #####')
  ...
  .then(function(){
    ...
    return Promise.resolve(1)
      .then( () =>{ log('then 5.0') } )
      .then( () =>{ throw 'A' } )
      .catch( (e) =>{ log('catch 5.0 - ' + e) } )
      .then( () =>{ log('then 5.1') } )
      .then( () => { throw 'B' } )
      .then( () =>{ log('then 5.2') } )
      .catch( (e) =>{ log('catch 5.1 - ' + e) } )
  })
  .then(function(){
    log('###### case 6 #####')
    ...
    return Promise.resolve(1)
      .then( () =>{ log('then 6.0') } )
      .then( () =>{ throw 'A' } )
      .catch( (e) =>{ return 'fallback value' } )
      .then( (x) =>{ log('then 6.1 - ' + x) } )
  })
